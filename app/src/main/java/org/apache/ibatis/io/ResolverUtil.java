...
public class ResolverUtil<T> {
  ...
  public ResolverUtil<T> find(Test test, String packageName) {
    ...
    try {
      ...
      android.util.Log.e(getClass().getCanonicalName(), "Could not read package: " + packageName, ioe);
    }
  ...
  protected void addIfMatching(Test test, String fqn) {
    try {
      ...
      android.util.Log.w(getClass().getCanonicalName(), "Could not examine class '" + fqn + "'" + " due to a " +
