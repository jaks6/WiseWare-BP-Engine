  ...
  public static VFS getInstance() {
    ...
    for (int i = 0; vfs == null || !vfs.isValid(); i++) {
      ...
      try {
        ...
        android.util.Log.e("VFS", "Failed to instantiate " + impl, e);
        return null;
...
//      return ReflectUtil.findClass(className);
  ...
  protected static Method getMethod(Class<?> clazz, String methodName, Class<?>... parameterTypes) {
    try {
      ...
      android.util.Log.e("VFS", "Security exception looking for method " + clazz.getName() + "." + methodName + ".  Cause: " + e);
      return null;
    } catch (NoSuchMethodException e) {
      android.util.Log.e("VFS", "Method not found " + clazz.getName() + "." + methodName + "." + methodName + ".  Cause: " + e);
      return null;
    }
  }
