...
//			xtr.next();
			if (eventType == XmlPullParser.START_TAG && ELEMENT_DI_LABEL.equalsIgnoreCase(xtr.getName())) {

				eventType = xtr.getEventType();
          ...
          if (eventType == XmlPullParser.START_TAG && ELEMENT_DI_BOUNDS.equalsIgnoreCase(xtr.getName())) {
            ...
            graphicInfo.setHeight(Double.valueOf(xtr.getAttributeValue(null, ATTRIBUTE_DI_HEIGHT)).intValue());
			  ...
			  eventType = xtr.next();
					  break;
          } else if(xtr.getEventType() == XmlPullParser.END_TAG && ELEMENT_DI_LABEL.equalsIgnoreCase(xtr.getName())) {
			  eventType = xtr.next();
            break;
          }
			eventType = xtr.next();
			...
			} else if (eventType == XmlPullParser.START_TAG && ELEMENT_DI_WAYPOINT.equalsIgnoreCase(xtr.getName())) {
				GraphicInfo graphicInfo = new GraphicInfo();
				BpmnXMLUtil.addXMLLocation(graphicInfo, xtr);
				graphicInfo.setX(Double.valueOf(xtr.getAttributeValue(null, ATTRIBUTE_DI_X)).intValue());
				graphicInfo.setY(Double.valueOf(xtr.getAttributeValue(null, ATTRIBUTE_DI_Y)).intValue());
			...
			} else if(eventType == XmlPullParser.END_TAG && ELEMENT_DI_EDGE.equalsIgnoreCase(xtr.getName())) {
				eventType = xtr.next();
				break;
			}
		  eventType = xtr.next();
