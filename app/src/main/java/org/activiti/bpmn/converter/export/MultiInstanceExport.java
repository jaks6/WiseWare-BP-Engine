...
public class MultiInstanceExport implements BpmnXMLConstants {
  ...
  public static void writeMultiInstance(Activity activity, XmlSerializer xtw) throws Exception {
    if (activity.getLoopCharacteristics() != null) {
      ...
      if (StringUtils.isNotEmpty(multiInstanceObject.getLoopCardinality()) ||
        ...
        xtw.startTag("",ELEMENT_MULTIINSTANCE);
        ...
        if (StringUtils.isNotEmpty(multiInstanceObject.getLoopCardinality())) {
          xtw.startTag("",ELEMENT_MULTIINSTANCE_CARDINALITY);
          xtw.text(multiInstanceObject.getLoopCardinality());
          xtw.endTag("", ELEMENT_MULTIINSTANCE_CARDINALITY);
        }
        if (StringUtils.isNotEmpty(multiInstanceObject.getCompletionCondition())) {
          xtw.startTag("",ELEMENT_MULTIINSTANCE_CONDITION);
          xtw.text(multiInstanceObject.getCompletionCondition());
          xtw.endTag("", ELEMENT_MULTIINSTANCE_CONDITION);
        }
        xtw.endTag("", ELEMENT_MULTIINSTANCE);
      }
    }
  }
}
