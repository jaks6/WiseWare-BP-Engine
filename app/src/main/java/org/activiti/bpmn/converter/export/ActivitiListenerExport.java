...
public class ActivitiListenerExport implements BpmnXMLConstants {
  ...
  public static boolean writeListeners(BaseElement element, boolean didWriteExtensionStartElement, XmlSerializer xtw) throws Exception {
  ...
  protected static boolean writeEventListeners(List<EventListener> eventListeners,
  	...
  	if(eventListeners != null && !eventListeners.isEmpty()) {
  		for(EventListener eventListener : eventListeners) {
             ...
             xtw.startTag(ACTIVITI_EXTENSIONS_NAMESPACE, ELEMENT_EVENT_LISTENER);
           ...
           BpmnXMLUtil.writeDefaultAttribute(ATTRIBUTE_LISTENER_DELEGATEEXPRESSION, eventListener.getImplementation(), xtw);
            ...
            xtw.endTag(ACTIVITI_EXTENSIONS_NAMESPACE, ELEMENT_EVENT_LISTENER);
  		}
  	}
	...
	private static boolean writeListeners(String xmlElementName, List<ActivitiListener> listenerList, boolean didWriteExtensionStartElement, XmlSerializer xtw) throws Exception {
    if (listenerList != null) {
      ...
      for (ActivitiListener listener : listenerList) {
        ...
        if (StringUtils.isNotEmpty(listener.getEvent())) {
          ...
          xtw.startTag(ACTIVITI_EXTENSIONS_NAMESPACE, xmlElementName);
          ...
          FieldExtensionExport.writeFieldExtensions(listener.getFieldExtensions(), true, xtw);
            ...
            xtw.endTag(ACTIVITI_EXTENSIONS_NAMESPACE, xmlElementName);
        }
      }
    }
    return didWriteExtensionStartElement;
