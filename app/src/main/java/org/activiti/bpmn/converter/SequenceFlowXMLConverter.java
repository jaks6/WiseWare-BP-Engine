...
public class SequenceFlowXMLConverter extends BaseBpmnXMLConverter {
  ...
  protected void writeAdditionalChildElements(BaseElement element, BpmnModel model, XmlSerializer xtw) throws Exception {
    ...
    if (StringUtils.isNotEmpty(sequenceFlow.getConditionExpression())) {
      xtw.startTag("",ELEMENT_FLOW_CONDITION);
      xtw.attribute(XSI_NAMESPACE, "type", "tFormalExpression");
      xtw.cdsect(sequenceFlow.getConditionExpression());
      xtw.endTag("", ELEMENT_FLOW_CONDITION);
    }
  }
}
