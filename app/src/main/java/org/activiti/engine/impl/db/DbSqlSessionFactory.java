...
public class DbSqlSessionFactory implements SessionFactory {
  ...
  static {
    ...
    // sqlite
    databaseSpecificLimitBeforeStatements.put("sqlite", "");
    databaseSpecificLimitAfterStatements.put("sqlite", "LIMIT #{maxResults} OFFSET #{firstResult}");
    databaseSpecificLimitBetweenStatements.put("sqlite", "");
    databaseOuterJoinLimitBetweenStatements.put("sqlite", "");
    databaseSpecificOrderByStatements.put("sqlite", defaultOrderBy);
