...
public class CopyOfSQLDroidResultSet implements ResultSet {
  
    private final Cursor c;
    private int lastColumnRead;

    public CopyOfSQLDroidResultSet(Cursor c) {
        this.c = c;
    }
  ...
  public boolean getBoolean(String columnName) throws SQLException {
    try {
      int index = c.getColumnIndex(columnName);
    	System.out.println(getClass().getCanonicalName() + ".getBoolean(): Column " + columnName + " has index " + index + " in column list: " + printColumnNames());
        System.out.println("getBoolean() for " + columnName + ": " + (c.getInt(index) != 0));
...
//    	System.out.println(getClass().getCanonicalName() + ".getByte(): Column " + columnName + " has index " + index + " in column list: " + printColumnNames());
        System.out.println("getByte() for " + columnName + ": " + c.getShort(index));
...
//    	System.out.println(getClass().getCanonicalName() + ".getBytes(): Column " + columnName + " has index " + index + " in column list: " + printColumnNames());
        System.out.println("getBytes() for " + columnName + ": " + c.getBlob(index));
...
//    	System.out.println(getClass().getCanonicalName() + ".getDouble(): Column " + columnName + " has index " + index + " in column list: " + printColumnNames());
        System.out.println("getDouble() for " + columnName + ": " + c.getDouble(index));
...
//    	System.out.println(getClass().getCanonicalName() + ".getFloat(): Column " + columnName + " has index " + index + " in column list: " + printColumnNames());
        System.out.println("getFloat() for " + columnName + ": " + c.getFloat(index));
  ...
  public int getInt(String columnName) throws SQLException {
    try {
      int index = c.getColumnIndex(columnName);
//    	System.out.println(getClass().getCanonicalName() + ".getBlob(): Column " + columnName + " has index " + index + " in column list: " + printColumnNames());
        System.out.println("getInt() for " + columnName + ": " + c.getInt(index));
...
//    	System.out.println(getClass().getCanonicalName() + ".getLong(): Column " + columnName + " has index " + index + " in column list: " + printColumnNames());
        System.out.println("getLong() for " + columnName + ": " + c.getLong(index));
      lastColumnRead = index;
...
//  	System.out.println(getClass().getCanonicalName() + ".getObject(): Column " + columnName + " has index " + index + " in column list: " + printColumnNames());
  ...
  public short getShort(String columnName) throws SQLException {
    try {
      int index = c.getColumnIndex(columnName);
    	System.out.println(getClass().getCanonicalName() + ".getShort(): Column " + columnName + " has index " + index + " in column list: " + printColumnNames());
...
//      }
      ...
      System.out.println("getString() for " + columnName + ": " + c.getString(index));
...
//    	index--;
  ...
  public boolean wasNull() throws SQLException {
    try {
        return c.isNull(lastColumnRead);
