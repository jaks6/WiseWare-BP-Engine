...
public class SQLDroidPreparedStatement implements PreparedStatement {
  ...
  public SQLDroidPreparedStatement(String sql, SQLDroidConnection sqldroid) {
	  if (sql.length() > 50)
		  	Log.v("SQLDroidPreparedStatement", "new SqlDroid prepared statement from " + sqldroid + ": " + sql.substring(0, 50));
	  else
		    Log.v("SQLDroidPreparedStatement", "new SqlDroid prepared statement from " + sqldroid + ": " + sql);
