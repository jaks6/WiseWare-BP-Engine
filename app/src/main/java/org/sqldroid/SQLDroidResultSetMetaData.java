...
import org.activiti.db.mapping.SQLiteMapping;
...
public class SQLDroidResultSetMetaData implements ResultSetMetaData {
	...
	public String getColumnClassName(int column) throws SQLException {
		...
		if (SQLiteMapping.columnClassMap.containsKey(columnName)) {
//			System.out.println(getClass().getCanonicalName() + ": FOUND column class " + SQLiteMapping.columnClassMap.get(columnName) + " for " + columnName);
			return SQLiteMapping.columnClassMap.get(columnName);
		}

		System.err.println(getClass().getCanonicalName() + ": *** Didn't find column class for " + columnName);
		return null;
	}
	...
	public String getColumnLabel(int column) throws SQLException {
		return cursor.getColumnName(column - 1);//TODO: ??? return cursor.getColumnName(column - 1);
	}
